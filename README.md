...
본 프로젝트는 FastF1 라이브러리를 활용하여 Formula 1 레이스 텔레메트리 및 랩 데이터를 수집하고, 타이어 수명(Tyre Life)에 따른 랩타임 저하 패턴을 분석 및 예측하는 머신러닝 포트폴리오입니다. 특히 **2025 캐나다 GP에서 조지 러셀이 보여준 압도적인 타이어 관리와 우승 전략**을 정량적으로 파악하는 것을 목표로 합니다.
